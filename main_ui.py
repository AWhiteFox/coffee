...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1031, 647)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1031, 601))
        ...
        self.add_btn.setGeometry(QtCore.QRect(0, 600, 131, 23))
        self.add_btn.setObjectName("add_btn")
        self.edit_btn = QtWidgets.QPushButton(self.centralwidget)
        self.edit_btn.setGeometry(QtCore.QRect(130, 600, 211, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_btn.setText(_translate("MainWindow", "Изменить выбранную строку"))
